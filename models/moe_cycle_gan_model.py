...
class MoECycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--emb_inner_features', type=int, default=8, help='inner features in embedding CNN, default 64')
    ...
    def backward_G(self, epoch):
        ...
        # lambda_MoE = 0
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + lambda_MoE * self.loss_emb_cls + self.loss_Gate_SUM
        self.loss_G.backward()
    
    def backward_C(self):
        # MoE classifier loss
        self.loss_emb_cls = self.criterionEmbCls(self.pred_C, self.real_C)
        self.loss_emb_cls.backward()
